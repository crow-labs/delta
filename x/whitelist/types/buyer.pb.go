...
type Buyer struct {
	...
	NumOrder uint64   `protobuf:"varint,3,opt,name=numOrder,proto3" json:"numOrder,omitempty"`
	OrderId  []string `protobuf:"bytes,4,rep,name=orderId,proto3" json:"orderId,omitempty"`
...
func (m *Buyer) GetNumOrder() uint64 {
	if m != nil {
		return m.NumOrder
	}
	return 0
...
func (m *Buyer) GetOrderId() []string {
	if m != nil {
		return m.OrderId
	}
	return nil
...
func init() {
	proto.RegisterType((*Buyer)(nil), "crowlabs.delta.whitelist.Buyer")
}
...
var fileDescriptor_aea94ae1e5bf3227 = []byte{
	...
	,
	...
	0x9f, 0xab, 0x0f, 0xf2, 0x9a, 0x2e, 0xc8, 0x6f, 0xfa, 0x60, 0xbf, 0xe9, 0x57, 0xe8, 0x23, 0xc2,
	0xa0, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0x1c, 0x08, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x82, 0xc3, 0x19, 0x47, 0x1d, 0x01, 0x00, 0x00,
}
...
func (m *Buyer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderId) > 0 {
		for iNdEx := len(m.OrderId) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintBuyer(dAtA, i, uint64(len(m.OrderId[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if m.NumOrder != 0 {
		i = encodeVarintBuyer(dAtA, i, uint64(m.NumOrder))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Name) > 0 {
	...
	if len(m.BuyerId) > 0 {
		...
		i = encodeVarintBuyer(dAtA, i, uint64(len(m.BuyerId)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Buyer) Size() (n int) {
	...
	if m.NumOrder != 0 {
		n += 1 + sovBuyer(uint64(m.NumOrder))
	}
	if len(m.OrderId) > 0 {
